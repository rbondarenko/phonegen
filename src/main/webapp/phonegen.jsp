...
<%@ page import="com.example.phonegen.Greeting" %>
<%@ page import="com.example.phonegen.Guestbook" %>
...
<%
    ...
    Key<Guestbook> theBook = Key.create(Guestbook.class, userName);
    ...
    if (greetings.isEmpty()) {
        ...
        for (Greeting greeting : greetings) {
            ...
            %><p><b>${fn:escapeXml(greeting_user)}</b> wrote:</p><blockquote>${fn:escapeXml(greeting_content)}</blockquote><%
        }
    }
%>
...
<form action="/phonegen.jsp" method="get">
    <div><input type="text" name="userName" value="${fn:escapeXml(userName)}"/></div>
